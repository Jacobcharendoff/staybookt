...
export default function ElectricalPage() {
  ...
  return (
    <MarketingLayout>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-slate-300 text-lg mb-16 max-w-2xl mx-auto">
            Growth OS built for electricians who need to keep the lights on (literally).
          </p>
      ...
      {/* 8. FINAL CTA */}
      <section className="py-20 bg-gradient-to-br from-yellow-600 via-yellow-700 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/setup"
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-yellow-700 font-semibold rounded-full hover:bg-yellow-50 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-0.5"
            >
              {t('electricalPage.ctaCta') }
              <Zap className="w-5 h-5" />
            </Link>
            <Link
              href="/contact"
