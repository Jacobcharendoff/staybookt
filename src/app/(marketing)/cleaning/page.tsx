    ...
    <MarketingLayout>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  {t('cleaningPage.seeInAction')}
                </Link>
              </div>
              <p className="mt-6 text-sm text-gray-500">{t('cleaningPage.noCardNeeded')}.</p>
            </div>
                ...
                <div className="relative bg-gradient-to-br from-cyan-50 to-blue-50 rounded-3xl p-8 border border-cyan-200">
                  <div className="space-y-4 text-cyan-900">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="font-semibold">{t('cleaningPage.bookClients24')}</div>
                        <div className="text-sm text-cyan-700">{t('cleaningPage.bookClientsDesc')}</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-cyan-600 flex-shrink-0 mt-0.5" />
                      <div>
                        <div className="font-semibold">{t('cleaningPage.recurringLocked')}</div>
                        <div className="text-sm text-cyan-700">{t('cleaningPage.recurringLockedDesc')}</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-cyan-600 flex-shrink-0 mt-0.5" />
                      <div>
                        <div className="font-semibold">{t('cleaningPage.getReviews')}</div>
                        <div className="text-sm text-cyan-700">{t('cleaningPage.getReviewsDesc')}</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle2 className="w-5 h-5 text-cyan-600 flex-shrink-0 mt-0.5" />
                      <div>
                        <div className="font-semibold">{t('cleaningPage.cutNoShows')}</div>
                        <div className="text-sm text-cyan-700">{t('cleaningPage.cutNoShowsDesc')}</div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              {t('cleaningPage.painPointsTitle')}
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              {t('cleaningPage.painPointsDesc')}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">
                {t('cleaningPage.noShows')}
              </h3>
              <p className="text-gray-600 mb-4">
                {t('cleaningPage.noShowsDesc')}
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                {t('cleaningPage.noShowsIssues').split('\n').map((issue, i) => (
                  <li key={i}>{issue}</li>
                ))}
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">
                {t('cleaningPage.recurringBooking')}
              </h3>
              <p className="text-gray-600 mb-4">
                {t('cleaningPage.recurringBookingDesc')}
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                {t('cleaningPage.recurringIssues').split('\n').map((issue, i) => (
                  <li key={i}>{issue}</li>
                ))}
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">
                {t('cleaningPage.reviewsGeneration')}
              </h3>
              <p className="text-gray-600 mb-4">
                {t('cleaningPage.reviewsGenerationDesc')}
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                {t('cleaningPage.reviewsIssues').split('\n').map((issue, i) => (
                  <li key={i}>{issue}</li>
                ))}
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">
                {t('cleaningPage.supplyCosts')}
              </h3>
              <p className="text-gray-600 mb-4">
                {t('cleaningPage.supplyCostsDesc')}
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                {t('cleaningPage.supplyIssues').split('\n').map((issue, i) => (
                  <li key={i}>{issue}</li>
                ))}
              </ul>
            </div>
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              {t('cleaningPage.keepScheduleFull')}
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              {t('cleaningPage.keepScheduleFullDesc')}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">
                {t('cleaningPage.onlineBooking')}
              </h3>
              <p className="text-gray-600 text-sm mb-4">
                {t('cleaningPage.onlineBookingDesc')}
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-600 flex-shrink-0 mt-0.5" />
                  <span>{t('cleaningPage.closeMorJobs')}</span>
                </li>
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-600 flex-shrink-0 mt-0.5" />
                  <span>{t('cleaningPage.getPaidAway')}</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">
                {t('cleaningPage.recurringConfirmations')}
              </h3>
              <p className="text-gray-600 text-sm mb-4">
                {t('cleaningPage.recurringConfirmationsDesc')}
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-600 flex-shrink-0 mt-0.5" />
                ...
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-600 flex-shrink-0 mt-0.5" />
                  <span>{t('cleaningPage.lockRevenue')}</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">
                {t('cleaningPage.autoReviewRequests')}
              </h3>
              <p className="text-gray-600 text-sm mb-4">
                {t('cleaningPage.autoReviewRequestsDesc')}
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-600 flex-shrink-0 mt-0.5" />
                  <span>{t('cleaningPage.moreReviews')}</span>
                </li>
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-cyan-600 flex-shrink-0 mt-0.5" />
                  <span>{t('cleaningPage.betterRanking')}</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">
                {t('cleaningPage.noShowPrevention')}
              </h3>
              <p className="text-gray-600 text-sm mb-4">
                {t('cleaningPage.noShowPreventionDesc')}
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">
                {t('cleaningPage.clientClassification')}
              </h3>
              <p className="text-gray-600 text-sm mb-4">
                {t('cleaningPage.clientClassificationDesc')}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-sm border border-gray-100">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-bold text-gray-900">{t('cleaningPage.testimonialAuthor')}</p>
                <p className="text-gray-600 text-sm">{t('cleaningPage.testimonialCompany')}</p>
                <p className="text-gray-500 text-xs">{t('cleaningPage.testimonialLocation')}</p>
              </div>
            </div>
          </div>
        </div>
