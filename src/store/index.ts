  ...
  contacts: [
    {
      ...
      kids: '2 - Emma 10, Lucas 7',
      pets: 'Golden retriever named Max',
      interests: 'Soccer coach, enjoys woodworking',
      personalNotes: 'Very detail-oriented, prefers morning appointments',
    },
    {
      name: 'Sarah Chen',
      ...
      kids: '1 - Sophie 3',
      interests: 'Tech gadgets, hiking',
      personalNotes: 'Prefers email communication, budget-conscious',
    },
    {
      ...
      pets: '2 cats - Whiskers and Mittens',
      interests: 'Golf enthusiast, wine collector',
      personalNotes: 'High-end finishes only, flexible on scheduling',
    },
    {
    ...
    },
    {
      ...
      kids: '3 - Carlos 14, Isabella 11, Miguel 8',
      pets: 'German shepherd named Rocco',
      interests: 'Cycling, property investment',
      personalNotes: 'Wants to schedule work quickly, bulk discounts available',
    },
    {
      name: 'Lisa Anderson',
    ...
    },
    {
      ...
      interests: 'Baseball fan, local sports events',
      personalNotes: 'Returning customer - give VIP treatment, used to work with Marcus',
    },
    {
      name: 'Patricia King',
